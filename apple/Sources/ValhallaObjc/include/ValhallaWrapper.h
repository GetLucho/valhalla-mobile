...
///
/// NO for a tile the origin does not have, which is normal coverage rather than a failure:
/// two of the sixteen level-2 tiles over Lake and Porter counties are Lake Michigan.
